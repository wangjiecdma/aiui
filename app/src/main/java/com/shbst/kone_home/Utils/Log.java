...
import com.shbst.kone_home.BuildConfig;
...
//        String tag = generateTag();
    ...
    private static final class Constant {
        ...
        private static final String STRING_OBJECT_TOSTRING_NULL = "Object[object to string is null]";
    ...
    private static final class ObjectUtil {
        ...
        private static String objectToString(Object object, int childLevel) {
            ...
            if (objString == null || objString.length() == 0) {
                return Constant.STRING_OBJECT_TOSTRING_NULL;
            }
            if (objString.startsWith(object.getClass().getName() + "@")) {
...
//                System.out.println(field.getName() + "**" + cla.getName() + "**" + isSubClass + "**" + o.toString());
    ...
    private static final class Utils {
         ...
         * @return msg list
         */
        static List<String> largeStringToList(String msg) {
